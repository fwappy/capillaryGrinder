...
const AnalogMenuInfo minfoFaceChipSetDistanceDistance = { "Distance", 29, 31, 1000, NO_CALLBACK, 0, 10, "um" };
...
const AnalogMenuInfo minfoFaceChipParametricChannel = { "ChannelDepth", 25, 29, 1000, NO_CALLBACK, 0, 10, "um" };
...
const AnalogMenuInfo minfoFaceChipParametricHeight = { "TaperHeight", 24, 27, 1000, NO_CALLBACK, 0, 10, "um" };
...
const AnalogMenuInfo minfoFaceChipParametricAngle = { "TaperAngle", 23, 25, 1000, NO_CALLBACK, 0, 10, "um" };
AnalogMenuItem menuFaceChipParametricAngle(&minfoFaceChipParametricAngle, 0, &menuFaceChipParametricHeight, INFO_LOCATION_PGM);
const AnalogMenuInfo minfoFaceChipParametricWide = { "WidestWidth", 22, 23, 1000, NO_CALLBACK, 0, 10, "um" };
AnalogMenuItem menuFaceChipParametricWide(&minfoFaceChipParametricWide, 0, &menuFaceChipParametricAngle, INFO_LOCATION_PGM);
const AnalogMenuInfo minfoFaceChipParametricThin = { "ThinnestWidth", 21, 21, 1000, NO_CALLBACK, 0, 10, "um" };
