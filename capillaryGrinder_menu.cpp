...
const AnalogMenuInfo minfoFaceChipParametricChannel = { "Channel", 25, 29, 1000, NO_CALLBACK, 0, 10, "um" };
...
const AnalogMenuInfo minfoFaceChipParametricHeight = { "Height", 24, 27, 1000, NO_CALLBACK, 0, 10, "um" };
...
const AnalogMenuInfo minfoFaceChipParametricAngle = { "Angle", 23, 25, 1000, NO_CALLBACK, 0, 10, "um" };
AnalogMenuItem menuFaceChipParametricAngle(&minfoFaceChipParametricAngle, 0, &menuFaceChipParametricHeight, INFO_LOCATION_PGM);
const AnalogMenuInfo minfoFaceChipParametricWide = { "Wide", 22, 23, 1000, NO_CALLBACK, 0, 10, "um" };
AnalogMenuItem menuFaceChipParametricWide(&minfoFaceChipParametricWide, 0, &menuFaceChipParametricAngle, INFO_LOCATION_PGM);
const AnalogMenuInfo minfoFaceChipParametricThin = { "Thin", 21, 21, 1000, NO_CALLBACK, 0, 10, "um" };
