...
const EnumMenuInfo minfoFaceChipSetDistanceStartGrindNotZeroed = { "NotZeroed", 32, 0xffff, 1, checkZeroed, enumStrFaceChipSetDistanceStartGrindNotZeroed };
...
const SubMenuInfo minfoFaceChipSetDistance = { "Set Distance", 20, 0xffff, 0, NO_CALLBACK };
BackMenuItem menuBackFaceChipSetDistance(&minfoFaceChipSetDistance, &menuFaceChipSetDistanceDistance, INFO_LOCATION_PGM);
SubMenuItem menuFaceChipSetDistance(&minfoFaceChipSetDistance, &menuBackFaceChipSetDistance, nullptr, INFO_LOCATION_PGM);
...
const EnumMenuInfo minfoFaceChipParametricStartGrindNotZeroed = { "NotZeroed", 28, 0xffff, 1, checkZeroed, enumStrFaceChipParametricStartGrindNotZeroed };
...
SubMenuItem menuFaceChipParametric(&minfoFaceChipParametric, &menuBackFaceChipParametric, &menuFaceChipSetDistance, INFO_LOCATION_PGM);
...
const EnumMenuInfo minfoFaceCapillaryStartGrindNotZeroed = { "NotZeroed", 18, 0xffff, 1, checkZeroed, enumStrFaceCapillaryStartGrindNotZeroed };
...
const EnumMenuInfo minfoGrindCapillaryStartGrindZeroFirst = { "NotZeroed", 13, 0xffff, 1, checkZeroed, enumStrGrindCapillaryStartGrindZeroFirst };
...
const AnyMenuInfo minfoCalibrateOffset = { "Offset", 5, 2, 0, NO_CALLBACK };
