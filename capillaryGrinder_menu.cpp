...
EnumMenuInfo minfoFaceChipSetDistanceStartGrindNotZeroed = { "NotZeroed", 32, 0xffff, 1, setZeroed, enumStrFaceChipSetDistanceStartGrindNotZeroed };
EnumMenuItem menuFaceChipSetDistanceStartGrindNotZeroed(&minfoFaceChipSetDistanceStartGrindNotZeroed, 0, nullptr, INFO_LOCATION_RAM);
...
EnumMenuInfo minfoFaceChipSetDistanceStartGrindStart = { "Start", 31, 0xffff, 1, startFaceChipDistance, enumStrFaceChipSetDistanceStartGrindStart };
EnumMenuItem menuFaceChipSetDistanceStartGrindStart(&minfoFaceChipSetDistanceStartGrindStart, 0, &menuFaceChipSetDistanceStartGrindNotZeroed, INFO_LOCATION_RAM);
...
const AnalogMenuInfo minfoFaceChipSetDistanceDistance = { "Distance", 29, 33, 1000, NO_CALLBACK, 0, 10, "um" };
...
EnumMenuInfo minfoFaceChipParametricStartGrindNotZeroed = { "NotZeroed", 28, 0xffff, 1, setZeroed, enumStrFaceChipParametricStartGrindNotZeroed };
EnumMenuItem menuFaceChipParametricStartGrindNotZeroed(&minfoFaceChipParametricStartGrindNotZeroed, 0, nullptr, INFO_LOCATION_RAM);
...
EnumMenuInfo minfoFaceChipParametricStartGrindStart = { "Start", 27, 0xffff, 1, startFaceChipParametric, enumStrFaceChipParametricStartGrindStart };
EnumMenuItem menuFaceChipParametricStartGrindStart(&minfoFaceChipParametricStartGrindStart, 0, &menuFaceChipParametricStartGrindNotZeroed, INFO_LOCATION_RAM);
...
const AnalogMenuInfo minfoFaceChipParametricChannel = { "ChannelDepth", 25, 31, 1000, NO_CALLBACK, 0, 10, "um" };
...
const AnalogMenuInfo minfoFaceChipParametricHeight = { "TaperHeight", 24, 29, 1000, NO_CALLBACK, 0, 10, "um" };
...
const AnalogMenuInfo minfoFaceChipParametricAngle = { "TaperAngle", 23, 27, 1000, NO_CALLBACK, 0, 10, "um" };
AnalogMenuItem menuFaceChipParametricAngle(&minfoFaceChipParametricAngle, 0, &menuFaceChipParametricHeight, INFO_LOCATION_PGM);
const AnalogMenuInfo minfoFaceChipParametricWide = { "WidestWidth", 22, 25, 1000, NO_CALLBACK, 0, 10, "um" };
AnalogMenuItem menuFaceChipParametricWide(&minfoFaceChipParametricWide, 0, &menuFaceChipParametricAngle, INFO_LOCATION_PGM);
const AnalogMenuInfo minfoFaceChipParametricThin = { "ThinnestWidth", 21, 23, 1000, NO_CALLBACK, 0, 10, "um" };
...
EnumMenuInfo minfoFaceCapillaryStartGrindNotZeroed = { "NotZeroed", 18, 0xffff, 1, setZeroed, enumStrFaceCapillaryStartGrindNotZeroed };
EnumMenuItem menuFaceCapillaryStartGrindNotZeroed(&minfoFaceCapillaryStartGrindNotZeroed, 0, nullptr, INFO_LOCATION_RAM);
...
EnumMenuInfo minfoFaceCapillaryStartGrindStart = { "Start", 17, 0xffff, 1, startFaceCapillary, enumStrFaceCapillaryStartGrindStart };
EnumMenuItem menuFaceCapillaryStartGrindStart(&minfoFaceCapillaryStartGrindStart, 0, &menuFaceCapillaryStartGrindNotZeroed, INFO_LOCATION_RAM);
...
const BooleanMenuInfo minfoFaceCapillaryCapillaryMotor = { "CapillaryMotor", 15, 22, 1, NO_CALLBACK, NAMING_ON_OFF };
...
const AnalogMenuInfo minfoFaceCapillaryDepth = { "Depth", 14, 20, 1000, NO_CALLBACK, 0, 10, "um" };
...
const char enumStrGrindCapillaryStartGrindNotZeroed_0[] = "Zero";
const char enumStrGrindCapillaryStartGrindNotZeroed_1[] = "Ignore";
const char* const enumStrGrindCapillaryStartGrindNotZeroed[]  = { enumStrGrindCapillaryStartGrindNotZeroed_0, enumStrGrindCapillaryStartGrindNotZeroed_1 };
EnumMenuInfo minfoGrindCapillaryStartGrindNotZeroed = { "NotZeroed", 13, 0xffff, 1, setZeroed, enumStrGrindCapillaryStartGrindNotZeroed };
EnumMenuItem menuGrindCapillaryStartGrindNotZeroed(&minfoGrindCapillaryStartGrindNotZeroed, 0, nullptr, INFO_LOCATION_RAM);
...
EnumMenuInfo minfoGrindCapillaryStartGrindStart = { "Start", 12, 0xffff, 1, startGrindCapillary, enumStrGrindCapillaryStartGrindStart };
EnumMenuItem menuGrindCapillaryStartGrindStart(&minfoGrindCapillaryStartGrindStart, 0, &menuGrindCapillaryStartGrindNotZeroed, INFO_LOCATION_RAM);
...
const AnalogMenuInfo minfoGrindCapillaryFaceWidth = { "FaceWidth", 10, 18, 1000, NO_CALLBACK, 0, 10, "um" };
AnalogMenuItem menuGrindCapillaryFaceWidth(&minfoGrindCapillaryFaceWidth, 0, &menuGrindCapillaryStartGrind, INFO_LOCATION_PGM);
const AnalogMenuInfo minfoGrindCapillaryAngleDegrees = { "AngleDegrees", 9, 16, 9000, NO_CALLBACK, 0, 100, "d" };
...
const AnalogMenuInfo minfoGrindCapillaryOuterDiameter = { "OuterDiameter", 8, 14, 1000, NO_CALLBACK, 0, 10, "um" };
...
const AnalogMenuInfo minfoGrindCapillaryInnerDiameter = { "InnerDiameter", 7, 12, 1000, NO_CALLBACK, 0, 10, "um" };
...
void setupMenu() {
    ...
    menuMgr.initForEncoder(&renderer, &menuCalibrate, 2, 3, 4);
